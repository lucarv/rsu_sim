...
var Amqp = /** @class */ (function () {
        ...
        this._fsm = new machina.Fsm({
            ...
            states: {
                disconnected: {
                    ...
                    connect: function (config, connectCallback) {
                        _this._fsm.transition('connecting', config, connectCallback);
                    },
    ...
    Amqp.prototype.connect = function (config, done) {
        ...
        var policyOverride = config.policyOverride || {};
    ...
    Amqp.prototype.attachReceiverLink = function (endpoint, linkOptions, done) {
        ...
        var newLinkOptions = linkOptions || {};
        if (this._config) {
