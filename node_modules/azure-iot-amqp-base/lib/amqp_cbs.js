                                    ...
                                    if (err) {
                                        ...
                                        _this._receiverLink.on('message', function (msg) {
                                            ...
                                            for (var i = 0; i < _this._putToken.outstandingPutTokens.length; i++) {
                                                if (msg.properties.correlationId === _this._putToken.outstandingPutTokens[i].correlationId) {
                                                    ...
                                                    if (completedPutToken.putTokenCallback) {
                                                        ...
                                                        if (msg.applicationProperties['status-code'] !== 200) {
                                                            ...
                                                            error = new azure_iot_common_1.errors.UnauthorizedError(msg.applicationProperties['status-description']);
                                                        }
